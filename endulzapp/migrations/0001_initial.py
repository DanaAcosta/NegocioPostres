    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario', models.CharField(max_length=50)),
                ('contrasena', models.CharField(max_length=50)),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='endulzapp.cliente')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('usuario_repartidor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='endulzapp.usuario_repartidor')),
            ],
        ),
        migrations.CreateModel(
            name='Categoria',
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='endulzapp.producto')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='endulzapp.cliente')),
                ('producto_en_carrito', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='endulzapp.producto_en_carrito')),
            ],
        ),
